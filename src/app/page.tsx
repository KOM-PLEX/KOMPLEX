...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="mt-15 pt-40 pb-40 px-5 bg-indigo-600 text-white text-center relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="absolute inset-0 overflow-hidden">
          {/* App Screenshot 1 */}
          <div className="absolute top-20 left-10 w-32 h-48 bg-white/10 backdrop-blur-sm rounded-xl transform rotate-12 shadow-2xl border border-white/20">
          ...
          {/* App Screenshot 2 */}
          <div className="absolute top-32 right-20 w-28 h-40 bg-white/10 backdrop-blur-sm rounded-xl transform -rotate-6 shadow-2xl border border-white/20">
            <div className="w-full h-full flex items-center justify-center text-white/60 text-xs">
              App Screenshot 2
            </div>
          </div>
          ...
          {/* App Screenshot 3 */}
          <div className="absolute bottom-20 left-1/4 w-36 h-52 bg-white/10 backdrop-blur-sm rounded-xl transform rotate-3 shadow-2xl border border-white/20">
            <div className="w-full h-full flex items-center justify-center text-white/60 text-xs">
              App Screenshot 3
            </div>
          </div>
          ...
          {/* App Screenshot 4 */}
          <div className="absolute bottom-32 right-10 w-24 h-36 bg-white/10 backdrop-blur-sm rounded-xl transform -rotate-12 shadow-2xl border border-white/20">
            <div className="w-full h-full flex items-center justify-center text-white/60 text-xs">
              App Screenshot 4
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {FEATURES.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`${feature.bgColor} ${feature.borderColor} border-2 rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl text-center backdrop-blur-sm`}
                >
                  <div className={`w-20 h-20 ${feature.bgColor} ${feature.borderColor} border-2 rounded-full flex items-center justify-center mx-auto mb-5`}>
      ...
      <section className="py-20 px-5 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="lg:order-1 bg-white rounded-2xl p-6 shadow-lg">
              <div className="w-full h-80 bg-gray-100 rounded-xl flex items-center justify-center">
                <div className="text-center">
      ...
      <section id="goals" className="py-20 px-5 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-15">
            {/* Problem Card */}
            <div className="bg-red-50/80 border-2 border-red-600 rounded-2xl p-8 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
            ...
            {/* Solution Card */}
            <div className="bg-green-50/80 border-2 border-green-600 rounded-2xl p-8 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
              <div className="flex items-center gap-3 mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {FOUNDERS.map((founder, index) => (
              <div
                key={index}
                className={`${founder.bgColor} ${founder.borderColor} border-2 rounded-2xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl text-center backdrop-blur-sm`}
              >
                <div className={`w-20 h-20 ${founder.bgColor} ${founder.borderColor} border-2 rounded-full flex items-center justify-center mx-auto mb-5 overflow-hidden`}>
                  <img
                    src={founder.image}
                    alt={founder.name}
                ...
                <div className={`${founder.iconColor} font-semibold text-base mb-4`}>{founder.role}</div>
