...
export default function PracticeResult({ examSections, overallScore, sectionScores, onRetakeExam }: PracticeResultProps) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">វិញ្ញាសាបានបញ្ចប់!</h1>
