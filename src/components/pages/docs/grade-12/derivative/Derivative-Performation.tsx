...
const TOPIC_CONTENT: TopicContent = {
  ...
  content: (
    ...
    example: {
  question: (
    <BlockMath math={String.raw`\text{គណនាដេរីវេ } \ f(x)=3x^4-5x^2+2`} />
  ),
  steps: [
    {
...
example: {
  ...
  steps: [
    {
      title: "ជំហានទី១៖ ច្បាប់ដែលនឹងប្រើ",
      content: (
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm min-w-0">
          <MathScroll math={String.raw`\frac{d}{dx}[u\pm v]=u'\pm v',\qquad \frac{d}{dx}[c\,u]=c\,u'`} />
          <MathScroll math={String.raw`\frac{d}{dx}[x^n]=n\,x^{\,n-1},\qquad \frac{d}{dx}[c]=0`} />
        </div>
      ),
    },

    {
      title: "ជំហានទី២៖ យកដេរីវេជាជួរផ្នែក",
      content: (
        <div className="rounded-xl border border-sky-200 bg-sky-50/40 p-4 shadow-sm min-w-0">
          <MathScroll math={String.raw`\frac{d}{dx}\big[3x^4-5x^2+2\big]
=3\,\frac{d}{dx}[x^4]-5\,\frac{d}{dx}[x^2]+\frac{d}{dx}[2]`} />
        </div>
      ),
    },
    ...
    {
      title: "ជំហានទី៣៖ គណនាដេរីវេនីមួយៗ",
      content: (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 min-w-0">
          <div className="rounded-lg border border-slate-200 bg-white p-3 shadow-sm min-w-0">
            <MathScroll math={String.raw`\frac{d}{dx}[x^4]=4x^3`} />
          </div>
          <div className="rounded-lg border border-slate-200 bg-white p-3 shadow-sm min-w-0">
            <MathScroll math={String.raw`\frac{d}{dx}[x^2]=2x`} />
          </div>
          <div className="rounded-lg border border-slate-200 bg-white p-3 shadow-sm min-w-0">
            <MathScroll math={String.raw`\frac{d}{dx}[2]=0`} />
          </div>
        </div>
      ),
    },
    ...
    {
      title: "ជំហានទី៤៖ បូកសរុប និងសម្រួល",
      content: (
        <div className="rounded-xl border border-emerald-200 bg-emerald-50/40 p-4 shadow-sm min-w-0">
          <MathScroll math={String.raw`f'(x)=3\cdot4x^3-5\cdot2x+0=12x^3-10x`} />
        </div>
      ),
    },
  ],
  ...
  answer: (
    <div className="rounded-xl border border-emerald-300 bg-white p-4 shadow-sm min-w-0">
      <MathScroll math={String.raw`f'(x)=12x^3-10x`} />
    </div>
  ),
},
