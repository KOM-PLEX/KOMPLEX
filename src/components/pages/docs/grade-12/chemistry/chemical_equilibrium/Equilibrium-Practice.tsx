...
const EquilibriumPractice = () => {
  ...
  const practiceExercises: PracticeExercise[] = [
    ...
    problems: [
      <div className="text-[13px]" key="q1">
    ...
    },
    {
      ...
      problems: [
          <div className="text-[13px] flex flex-col items-start gap-3" key="q1">
          ...
          <div className="text-[13px] flex flex-col items-start gap-3" key="q2">
          ...
          <div className="text-[13px] flex flex-col items-start gap-3" key="q3">
          ...
          <div className="text-[13px] flex flex-col items-start gap-3" key="q4">
    ...
    },
    {
      ...
      problems: [
        ...
        <div className="flex flex-col gap-3 text-[13px] items-start" key="q2">
    ...
    },
    {
      ...
      problemType: "Sixth Exercise",
      problems: [
        <div className="flex flex-col gap-3 text-[13px] items-start" key="q1">
