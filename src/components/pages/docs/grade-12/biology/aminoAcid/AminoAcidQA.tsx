    ...
    const practiceExercises: PracticeExercise[] = [
        {
          ...
          problems: [
                <p>ដូចម្តេចដែលហៅថា ប៉ិបទីត? ចំណងប៉ិបទីត?</p>
          ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
                <p>_ ប៉ិបទីត ជាបណ្ដុំនៃការភ្ជាប់រវាងអាស៊ីតអាមីនេពីរ ឬច្រើន តែមិនលើសពី១០។</p>
                <p>_ ចំណងប៉ិបទីត ជាសម្ព័ន្ធកូវ៉ាឡង់ដែលភ្ជាប់រវាងបណ្តុំកាបុកស៊ីល (-COOH) នៃអាស៊ីតអាមីនេមួយ ទៅនឹងបណ្ដុំអាមីន <span className="text-[13px]"><InlineMath math="NH_{2}" /></span> នៃអាស៊ីតអាមីនេមួយទៀតដោយបាត់បង់មួយម៉ូលេគុលទឹក។</p>
            </div>
          ]
        },
        {
          ...
          problems: [
                <p>ហេតុអ្វីបានជាគេនិយាយថា អាស៊ីតអាមីនេជាសារធាតុចំណូលទឹក?</p>
          ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
                <p>បានជាគេនិយាយថាអាស៊ីតអាមីនេជាសារធាតុចំណូលទឹក ព្រោះវារលាយក្នុងទឹក ហើយអាចជ្រាបចូលតាមភ្នាស
        ...
        },
        {
          ...
          problems: [
                <p>តើម៉ូលេគុលអាស៊ីតអាមីនេនីមួយៗផ្សំឡើងពីអ្វីខ្លះ? ចូរសរសេររូបមន្តទូទៅរបស់អាស៊ីតអាមីនេ។</p>,
          ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
        ...
        },
        {
          ...
          problems: [
                <p>ហេតុអ្វីបានជាគេនិយាយថា តំណលំដាប់អាស៊ីតអាមីនេកំណត់ទម្រង់ និងនាទីរបស់ប្រូតេអ៊ុន?</p>
            ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
                <p>បានជាគេនិយាយថាតំណលំដាប់អាស៊ីតអាមីនេកំណត់ទម្រង់ និងនាទីរបស់ប្រូតេអ៊ីន ពីព្រោះលំដាប់តម្រៀប
        ...
        },
        {
          ...
          problems: [
                <p>ចូរសរសេររូបមន្តឌីប៉ិបទីតដែលកើតឡើងពីការភ្ជាប់រវាងអាស៊ីតអាមីនេពីរ។</p>
          ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
                <div className="flex items-start gap-1 text-[12px]">
        ...
        },
        {
          ...
          problems: [
              <p>គេនិយាយថា អាស៊ីតអាមីនេមានលក្ខណះជាអាស៊ីតផង និងជាបាសផង។ តើពិតឬទេ? ចូរបញ្ជាក់អំណះអំណាងរបស់អ្នក។</p>
          ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
        ...
        },
        {
          ...
          problems: [
              <p>ហេតុអ្វីបានជាគេនិយាយថា អាស៊ីតអាមីនេជាអ្នកនាំសារ? ក្រៅពីអ្នកនាំសារ តើវាមាននាទីអ្វីទៀត។</p>
          ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
        ...
        },
        {
          ...
          problems: [
              <p>ដូចម្តេចដែលហៅថា អាស៊ីតអាមីនេស្តង់ដា? អាស៊ីតអាមីនេគ្មានស្តង់ដា?</p>
          ],
          answers: [
            <div className="flex flex-col gap-3 text-[15px]">
