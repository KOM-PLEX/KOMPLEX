...
const FourthTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc ml-5 flex flex-col gap-3">
            <li>ចលនការចម្លងក្រមប្រព្រឹត្តទៅនៅក្នុងណ្វៃយ៉ូនៃកោសិកាក្នុងចន្លោះវគ្គរបស់វដ្តកោសិកា។</li>
            <li><span className="text-[13px]"><InlineMath math="ARN_{m}" /></span> ចម្លងព័ត៌មានសេនេទិចចេញពី ច្រវាក់ម្ខាងរបស់អង្កត់ADNឬសែន។</li>
            <li>អង់ស៊ីមARNប៉ូលីមេរ៉ាសមាននាទី:</li>
            <p>_ ទទួលស្គាល់សញ្ញាសេនេទិចនៅលើADNដែលអាចឲ្យចាប់ផ្តើមនិងបញ្ចប់ការសំយោគ <span className="text-[13px]"><InlineMath math="ARN_{m} " /></span> ត្រង់កន្លែងជាក់លាក់</p>
            <p>_ បើកម៉ូលេគុល ADN ដោយផ្តាច់សម្ព័ន្ធអ៊ីដ្រូសែនខ្សោយ ដែលភ្ជាប់ច្រវាក់ទាំងពីរ។</p>
            <p>_ ធ្វើឲ្យមានប៉ូលីមែកម្មនៃនុយក្លេអូទីត (ឬការសំយោគARN): រីបូនុយក្លេអូទីតសេរីចូលទៅភ្ជាប់នឹងនុយក្លេអូទីតនៃច្រវាក់ម្ខាងរបស់អង្កត់ADN តាមគោលការណ៍បំពេញបាសគឺ A-U, T-A, C-G, G-C ។</p>
            <p>_ ពេលសំយោគរួចARN ក៏ផ្តាច់ខ្លួនចេញពីADN ហើយចាកចេញពីណៃ្វយ៉ូទៅក្នុងស៊ីតូប្លាស។</p>
            <p>_ ច្រវាក់ADNទាំងពីរ ក៏ភ្ជាប់គ្នាវិញ។</p>
            <p>_ ដូចនេះARN មាននាទីចម្លងព័ត៌មានសេនេទិចគឺ ចម្លងតំណលំដាប់នុយក្លេអូទីតច្រវាក់ម្ខាងរបស់អង្កត់ADN ឬសែនឲ្យទៅជាតំណលំដាប់រីបូនុយក្លេអូទីត ហើយបញ្ជូនតំណលំដាប់នេះទៅកាន់រីបូសូមដើម្បីសំយោគប្រូតេអ៊ីន។</p>
        </ul>
      </>
    ),
  },
