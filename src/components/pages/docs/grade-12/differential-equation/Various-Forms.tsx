        ...
        questions: [
          {
            ...
            options: [
              <InlineMath math={"y = 3x^3 - e^x + C"} />,
              <InlineMath math={"y = x^3 - e^x + x + C"} />,
              <InlineMath math={"y = x^3 + e^x + x + C"} />,
              <InlineMath math={"y = x^2 - e^x + x + C"} />,
            ],
            correctAnswer: 1,
          },
          {
            ...
            options: [
              <InlineMath math={"y = \\frac{1}{2} e^{x^2} + 2x + C"} />,
              <InlineMath math={"y = e^{x^2} + 2x + C"} />,
              <InlineMath math={"y = \\frac{1}{2} e^{x} + 2x + C"} />,
              <InlineMath math={"y = \\frac{1}{2} e^{x^2} + x + C"} />,
            ],
            correctAnswer: 0,
          },
        ],
        ...
        questions: [
          {
            ...
            options: [
              <InlineMath math={"\\arctan y = \\frac{x^2}{2} + C"} />,
              <InlineMath math={"\\arctan y = x^2 + C"} />,
              <InlineMath math={"y^2 = x^2 + C"} />,
              <InlineMath math={"y = e^{x^2} + C"} />,
            ],
            correctAnswer: 0,
          },
          {
            ...
            options: [
              <InlineMath math={"y = 2Cx"} />,
              <InlineMath math={"y = Cx^2"} />,
              <InlineMath math={"y^2 = Cx"} />,
              <InlineMath math={"y = Cx"} />,
            ],
            correctAnswer: 1,
          },
          {
            ...
            options: [
              <InlineMath math={"y = e^{x} + C"} />,
              <InlineMath math={"e^{-y} = e^{x} + C"} />,
              <InlineMath math={"y = x + C"} />,
              <InlineMath math={"e^{y} = e^{x} + C"} />,
            ],
            correctAnswer: 3,
          },
