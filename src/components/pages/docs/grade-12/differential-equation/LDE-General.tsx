    ...
    questions: [
        {
          ...
          options: [
            <InlineMath math={"y = A e^{x} + B e^{2x} + C e^{3x}"} />,
            <InlineMath math={"y = A e^{-x} + B e^{-2x} + C e^{-3x}"} />,
            <InlineMath math={"y = A e^{3x} + B e^{6x} + C e^{9x}"} />,
            <InlineMath math={"y = (A + Bx) e^{x} + C e^{2x}"} />,
          ],
          correctAnswer: 2,
        },
        {
          ...
          options: [
            <InlineMath math={"y = A e^{x} + B e^{2x} + C e^{3x} + D e^{4x}"} />,
            <InlineMath math={"y = (A + Bx) e^{x} + (C + D x) e^{2x}"} />,
            <InlineMath math={"y = A e^{-x} + B e^{-2x} + C e^{-3x} + D e^{-4x}"} />,
            <InlineMath math={"y = A e^{x} + B x e^{x} + C e^{3x} + D e^{4x}"} />,
          ],
          correctAnswer: 1,
        },
        {
          ...
          options: [
            <InlineMath math={"y = (A + Bx + C x^{2}) e^{-x}"} />,
            <InlineMath math={"y = A e^{x} + B e^{2x} + C e^{3x}"} />,
            <InlineMath math={"y = (A + B x) e^{x} + C e^{x^{2}}"} />,
            <InlineMath math={"y = A e^{-x} + B e^{-2x} + C e^{-3x}"} />,
          ],
          correctAnswer: 3,
        },
        ...
        questions: [
          {
              ...
              options: [
                ...
                <InlineMath math={"y = (A + Bx + Cx^2) e^{x} + x e^{x}"} />,
                <InlineMath math={"y = (A + Bx) e^{x} + x^2 e^{x}"} />,
                <InlineMath math={"y = (A + Bx + Cx^2) e^{x} + e^{x}"} />,
                <InlineMath math={"y = (A + Bx + Cx^2)e^x + \\frac{1}{6} x^3 e^{x}"} />,
              ],
              correctAnswer: 3,
            },
            {
              ...
              options: [
                <InlineMath math={"y = (A + Bx + Cx^2 + Dx^3) e^{x} + a x^2 + b x + c"} />,
                <InlineMath math={"y = (A + Bx + Cx^2 + Dx^3) e^{x} + x^2 e^{x}"} />,
                <InlineMath math={"y = (A + Bx + Cx^2) e^{x} + x^3"} />,
                <InlineMath math={"y = (A + Bx + Cx^2 + Dx^3) e^{x} + e^{x}"} />,
              ],
              correctAnswer: 0,
            },
            {
              ...
              options: [
                <InlineMath math={"y_p = A \cos x + B \sin x"} />,
                <InlineMath math={"y_p = (A x + B) \cos x + (C x + D) \sin x"} />,
                <InlineMath math={"y_p = (A x^2 + B x + C) \cos x + (D x^2 + E x + F) \sin x"} />,
                <InlineMath math={"y_p = A e^{x} + B e^{-x}"} />,
              ],
              correctAnswer: 1,
            },
        ]
