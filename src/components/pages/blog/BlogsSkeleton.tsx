    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className=" p-5 max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="relative aspect-[16/8] w-full rounded-2xl overflow-hidden border border-indigo-500/10 animate-pulse">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-end p-6 lg:p-8">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <div className="flex items-center gap-1.5">
                                    <div className="w-4.5 h-4.5 rounded-full bg-gray-300 border border-white/30"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  gap-6">
                    {[...Array(6)].map((_, index) => (
                        <div key={index} className="relative aspect-[16/8] w-full rounded-2xl overflow-hidden border border-indigo-500/10 animate-pulse">
                            {/* Background Image Skeleton */}
                            <div className="absolute inset-0 w-full h-full bg-gray-200"></div>
